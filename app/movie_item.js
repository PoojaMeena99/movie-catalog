            ...
            {movie_list.map((movie) => (
                <div className="row display_movie" key={movie.title}>
                    ...
                    <div className="col-9 movie_info">
                        ...
                        <p className="movie_details">{movie.details} • Year {movie.release_year} • {movie.length_in_min} min • Imdb Rating: {movie.imdb_rating} • Rating Count: {movie.rating_count}</p>
